...
Qs = var[0]
As = var[1]
F = Factorbase(k,13710,N)
D = Qfactor(Qs, As, F, UB)
print("Eksponentmatricen er lavet")
Gamma = D[0]
Q = D[1]
A = D[2]
K = GaussElim(Gamma)
print("Gauss-eliminationen er udført")
M = K[0]
H = K[1]
print(FindFactor(M,H,Q,A,N))
print("Algoritmen er udført på", time()-total_time, "sekunder")
